...
export default function NavBar() {
  ...
  return (
    <>
      ...
      >
        <div className={clsx("h-full fixed top-0 right-0 bg-slate-950 text-slate-100 p-4 index-10 transition-transform duration-300",
          ...
          <ul className="mt-9 flex flex-col gap-5">
            <li>
              <Link href={"#"} onClick={() => setIsToggled(prev => !prev)}>Home</Link>
            </li>
            <li>
              <Link href={"#"} onClick={() => setIsToggled(prev => !prev)}>All Products</Link>
            </li>
            <li>
              <Link href={"#"} onClick={() => setIsToggled(prev => !prev)}>About</Link>
            </li>
            <li>
              <Link href={"/login"} onClick={() => setIsToggled(prev => !prev)}>Log in</Link>
            </li>
          </ul>
        </div>
      </div>
